        ...
        public async Task<List<ReorderRecommendation>> GetReorderRecommendationsAsync()
        {
            return await _context.Products
                ...
                .Select(p => new ReorderRecommendation
                {
                    ...
                    CurrentStock = p.Inventories.Sum(i => i.QuantityAvailable),
                    ReorderLevel = p.ReorderLevel,
                    RecommendedQuantity = p.ReorderQuantity,
                    EstimatedCost = p.ReorderQuantity * p.CostPrice
                })
        ...
        public async Task<List<DeadStockReport>> GetDeadStockReportAsync()
        {
            ...
            return await _context.Products
                ...
                .Select(p => new DeadStockReport
                {
                    ...
                    QuantityOnHand = p.Inventories.Sum(i => i.QuantityOnHand),
        ...
        public async Task<List<SupplierPerformanceReport>> GetSupplierPerformanceReportAsync()
        {
            return await _context.Suppliers
                ...
                .Select(s => new SupplierPerformanceReport
                {
                    ...
                    OnTimeDeliveries = s.PurchaseOrders.Count(po =>
                        po.ActualDeliveryDate <= po.ExpectedDeliveryDate && po.Status == "Completed"),
                    AverageLeadTime = (decimal)s.PurchaseOrders
    .Where(po => po.ActualDeliveryDate != null && po.OrderDate != null)
    .Average(po => (po.ActualDeliveryDate.Value - po.OrderDate).TotalDays),
