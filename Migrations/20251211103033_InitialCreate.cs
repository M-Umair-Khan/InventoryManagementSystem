        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextReorderDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineTotal = table.Column<decimal>(type: "decimal(10,2)", nullable: false, computedColumnSql: "[QuantityOrdered] * [UnitPrice] * (1 - [DiscountPercent]/100)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineTotal = table.Column<decimal>(type: "decimal(10,2)", nullable: false, computedColumnSql: "[QuantityOrdered] * [UnitCost]"),
